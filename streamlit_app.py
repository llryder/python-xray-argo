...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'streamlit.ryderaaa.dpdns.org')          # Argo固定隧道域名,留空即使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiMTRiNTAyNmRjNjZhMGI3ZmRlMThmODhkY2ExNmU2YWYiLCJ0IjoiYTQzZmViYzctYzcyNC00ZjIyLTk0NjUtNjI3MmNlNDBjM2FlIiwicyI6IlpURmpaall5TVRjdE1EQmtNaTAwT1RKbUxXRXhabVl0WXpVeVpqUmtZbUUyTVdKbSJ9')              # Argo固定隧道密钥,留空即使用临时隧道
